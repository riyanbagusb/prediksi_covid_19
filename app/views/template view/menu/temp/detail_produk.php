<div class="container-fluid d-sm-block">
	<div class="container">
		...
		<div class="modal fade" id="modalPerusahaan" tabindex="-1" role="dialog" aria-labelledby="modalDetailPerusahaan" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="modalDetailPerusahaanLabel">Tambah Perusahaan</h5>
